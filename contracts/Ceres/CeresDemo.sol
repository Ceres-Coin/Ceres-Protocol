...
contract CeresDemo is Context, IERC20, Ownable {
    ...
    constructor (address _router_address) public {
        ...
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(_router_address); // BSC Testnet
