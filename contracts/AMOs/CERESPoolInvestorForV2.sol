...
contract CeresPoolInvestorForV2 is AccessControl, Owned {
    ...
    ERC20 private cUSDC;
    ERC20 private aaveUSDC_Pool;
    ERC20 private yUSDC_V2;
    ERC20 private aaveUSDC_Token;
    ...
    function showAllocations() external view returns (uint256[5] memory allocations) {
        ...
        allocations[1] = (yUSDC_V2.balanceOf(address(this))).mul(1e6).div(1e6); // TODO: ADD CODE TO GET pricePerShare();
        ...
        allocations[3] = (cUSDC.balanceOf(address(this)).mul(1e18).div(1e18)); // Compound. Note that cUSDC is E8 // TODO: ADD CODE FOR cUSDC.exchangeRateStored()
    ...
    function mintRedeemPart1(uint256 frax_amount) public onlyByOwnerOrGovernance {
        ...
        // Redeem the frax
        CERES.approve(address(pool), frax_amount);
        pool.redeemFractionalCERES(frax_amount, 0, 0);
    }
